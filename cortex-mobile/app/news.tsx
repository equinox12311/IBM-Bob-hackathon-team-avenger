...
const makeStyles = (Colors: ReturnType<typeof useThemeMode>['Colors']) => StyleSheet.create({
  ...
  filterRow: { maxHeight: 44, backgroundColor: Colors.surfaceContainerLowest, borderBottomWidth: 1, borderBottomColor: Colors.outlineVariant },
  filterChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: Colors.outlineVariant, backgroundColor: Colors.surfaceContainerLowest, marginRight: 6 },
  ...
  articleCard: { flexDirection: 'row', backgroundColor: Colors.surfaceContainerLowest, borderRadius: 12, borderWidth: 1, borderColor: Colors.outlineVariant, overflow: 'hidden' },
  categoryBar: { width: 4 },
  ...
  articleTitle: { fontSize: 15, fontWeight: '700', color: Colors.onSurface, lineHeight: 22, marginBottom: 6 },
